...
//!
//!```rust
//! // Nightly and the `proc_macro_hygiene` feature are required because proc 
...
//!         // A vararg argument. 
//!         // The macro accepts an arbitrary amount of trailing values which will be collected to a Vec.
//!         // NOTE the * after the argument name.
//!         roles*: Vec<&str>,
//!     ) -> String {
//!         format!(
